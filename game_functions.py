...
def check_aliens_bottom(screen, aliens):
    ...
    for alien in aliens:
        if alien.rect.centery > screen_rect.bottom:
            # Start the aliens at the top again
            alien.rect.centery = screen_rect.top # less parameters

            # Optional: Lose a life if alien reaches bottom
            # ship_hit(ai_settings, stats, screen, ship, aliens, bullets)
            break
